...
class Scoreboard:
	...
	def __init__(self, ai_game):
		"""initialized scorekeeping attributes"""
	...
	def prep_level(self):
		...
		level_str_labeled = f"Level: {level_str}"
		self.level_image = self.font.render(level_str_labeled, True, self.text_color, self.settings.bg_color)
